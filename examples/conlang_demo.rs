...
pub enum ColorValue {
    ...
    Bright, // Added for compatibility
}
...
pub enum AspectValue {
    Magic, Life, Death, Spirit, Ancient, New, Fast, Slow, Sharp, Dull, Aggressive, Peaceful, Observant, Hidden, Power, Growth, Healing, Sound, Emotional, Artistic, Wind, Delicate, Predator,
}
    ...
    pub fn new() -> Self {
        Lexicon {
            prefixes: vec![
                ...
                Morpheme { text: "Glin".to_string(), morpheme_type: MorphemeType::Prefix, semantic_tags: HashMap::from([(SemanticTag::Color(ColorValue::Bright), 0.9), (SemanticTag::Aspect(AspectValue::Life), 0.8), (SemanticTag::Quality(QualityValue::Rare), 0.7)]) },
            ...
            suffixes: vec![
                Morpheme { text: "ia".to_string(), morpheme_type: MorphemeType::Suffix, semantic_tags: HashMap::from([(SemanticTag::Biome(BiomeType::Forest), 0.8), (SemanticTag::Aspect(AspectValue::Life), 0.7)]) },
                ...
                Morpheme { text: "lume".to_string(), morpheme_type: MorphemeType::Suffix, semantic_tags: HashMap::from([(SemanticTag::Flora, 0.9), (SemanticTag::Aspect(AspectValue::Growth), 0.8), (SemanticTag::Aspect(AspectValue::Life), 0.7)]) },
...
fn select_morpheme<'a, R: Rng>(
    ...
    // let weights: Vec<f32> = scored_morphemes.iter().map(|(_, score)| *score).collect(); // unused
...
fn main() {
    ...
    let mut rng = rand::rngs::ThreadRng::new().unwrap(); wait no bad.
